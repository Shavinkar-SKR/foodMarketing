    ...
    <div className="min-h-screen bg-white font-roboto">
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 font-roboto">
              ...
              reality menu system. Revolutionize the way your customers view,
              order, and enjoy their food in a completely immersive environment.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="card bg-white p-6 rounded-md shadow-lg">
              ...
              <p>
                View dishes in stunning 3D before placing your order, enhancing
                your dining experience. See your meal come to life before your
                eyes!
              </p>
            </div>
            {/* Feature 2 */}
            <div className="card bg-white p-6 rounded-md shadow-lg">
              ...
              <p>
                Track your food in real-time from kitchen to table with live
                updates, ensuring a smoother experience with minimal waiting.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="card bg-white p-6 rounded-md shadow-lg">
              ...
              <p>
                ...
                allergies, and past orders. ARoma knows your tastes!
              </p>
            </div>
            {/* Feature 4 */}
            <div className="card bg-white p-6 rounded-md shadow-lg">
              ...
              <p>
                Interact with your food in a completely immersive AR experience.
                Discover detailed nutritional information and presentation
                styles.
              </p>
            </div>
            {/* Feature 5 */}
            <div className="card bg-white p-6 rounded-md shadow-lg">
              ...
              <p>
                ARoma supports multiple languages, catering to customers from
                different regions. Enjoy a truly inclusive dining experience.
              </p>
            </div>
            {/* Feature 6 */}
            <div className="card bg-white p-6 rounded-md shadow-lg">
              ...
              <p>
                Gain insights into your restaurant’s operations with powerful
                analytics, helping you make data-driven decisions to improve
      ...
      <section id="download" className="py-24 bg-red-600/10">
        <div className="container text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 font-roboto">
            Take your dining experience to the next level. ARoma is now
            available on both Google Play and the Apple Store. Get real-time
            insights, adaptive learning, and a seamless experience across all
            devices.
          </p>
      ...
      <section id="about" className="py-24 bg-red-50">
        <div className="container text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 font-roboto">
            ARoma is a restaurant management solution designed to provide a
            futuristic dining experience through augmented reality technology.
            With features like interactive 3D menus, personalized
            recommendations, and order tracking, we are redefining how
            restaurants interact with customers. Our goal is to create a
            platform that enhances customer satisfaction, reduces wait times,
            and boosts restaurant efficiency.
          </p>
          <p className="text-lg text-muted-foreground mb-8 font-roboto">
            Our team of developers and engineers work tirelessly to create
            innovative solutions that improve both the customer dining
            experience and restaurant management processes. Whether you’re a
            small café or a large fine-dining establishment, ARoma will elevate
            your service and streamline your operations.
          </p>
          ...
          <div className="flex justify-center gap-8">
            <a
              href="https://www.linkedin.com/in/chnud-alahakoon-5a8176290/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/methuli-perera-1636252bb?trk=contact-info"
              target="_blank"
              rel="noopener noreferrer"
              className="text-red-600 hover:text-red-800"
            >
            ...
            <a
              href="https://www.linkedin.com/in/shavinkarskr"
              target="_blank"
              rel="noopener noreferrer"
              className="text-red-600 hover:text-red-800"
            >
            ...
            <a
              href="http://www.linkedin.com/in/wiruni-withana"
              target="_blank"
              rel="noopener noreferrer"
              className="text-red-600 hover:text-red-800"
            >
            ...
            <a
              href="https://www.linkedin.com/in/asnam-sanaf-112b02352/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-red-600 hover:text-red-800"
            >
